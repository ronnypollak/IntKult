...
To open a door, the drone sends a wireless signal and calls the public \texttt{open()} operation of the \texttt{DoorHandle} class and passes in the password for the door. 
